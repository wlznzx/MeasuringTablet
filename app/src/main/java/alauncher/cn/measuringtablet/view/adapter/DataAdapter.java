...
public class DataAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    @NonNull
    @Override
    public alauncher.cn.measuringtablet.base.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return alauncher.cn.measuringtablet.base.ViewHolder.createViewHolder(context, parent, R.layout.data_list_item);
    }

    @Override
    public void onBindViewHolder(@NonNull alauncher.cn.measuringtablet.base.ViewHolder holder, int position) {
