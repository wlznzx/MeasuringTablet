...
//                _datas.add(new MainInfo("alauncher.cn.measuringtablet.view.CalibrationActivity", R.string.calibration, R.drawable.straighten));
                _datas.add(new MainInfo("alauncher.cn.measuringtablet.view.Code2Activity", R.string.program_management, R.drawable.code));
...
//                _datas.add(new MainInfo("alauncher.cn.measuringtablet.view.SPCStatisticalActivity", R.string.spc_analysis, R.drawable.show_chart));
                _datas.add(new MainInfo("alauncher.cn.measuringtablet.view.TemplateManagerActivity", R.string.template_management, R.drawable.template));
